...
def pahari():
    ...
    The temple is dedicated to Shiva. This temple is located at 2140 feet above sea level and 350 feet above the ground.
    To reach the temple one has to climb 468 steps.\n The entire Ranchi city can be seen from the temple.
    Lord Shiva is worshiped in linga form in the hill temple. 
    There is a large crowd of Shiva devotees here during the month of Shivaratri and Sawan.\n
    The story of the hill temple of Ranchi\n the capital of Jharkhand, is very interesting. 
    This temple of Lord Shiva situated on the mountain was in the possession of the British before the independence of 
    the country and they used to hang the Freedom Fighters here.\n Since Independence, 
    the national flag is also hoisted with Independence Day and Republic Day along with religious flags on this temple.\n 
    ...
    The old name of the Pahari Baba temple was Tiriburu which later changed to 'Hanging Garry' 
    in British times because Freedom Fighters were hanged here under the British rule.\n
    ...
    There is a stone in the hill temple, on which the message of freedom of the country is written on the midnight of August 14 and 15, 1947.''',
    bg = "black",fg = "red", font = "times 12", justify = "left")
